...
const loginConfirmationTemplate = (userName, userEmail, loginDateTime) => {
  ...
  return `
    ...
    <head>
      ...
      <title>Confirmación de Registro - Taller Interestellar</title>
      <style>
        * {
          margin: 0;
          padding: 0;
    ...
    <body>
      <div class="email-container">
        ...
        <div class="content">
          ...
          <div class="message">
            Te confirmamos que tu sesión en <strong>Taller Interestellar</strong> se registró correctamente.
          </div>
          ...
          <div class="details-card">
            ...
            <div class="detail-item">
              ...
              <span class="detail-value">${loginDateTime}</span>
            </div>
            <div class="detail-item">
...
module.exports = { loginConfirmationTemplate };